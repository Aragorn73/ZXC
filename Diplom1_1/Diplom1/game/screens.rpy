...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("О Дипломе") action ShowMenu("about")
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(15, 70, 380, 90) action Start()
        hotspot(15, 160, 450, 100) action ShowMenu("load")
        hotspot(15, 260, 480, 90) action ShowMenu("preferences")
        hotspot(15, 350, 420, 100) action ShowMenu("about")
        hotspot(15, 450, 450, 100) action ShowMenu("help")
        hotspot(15, 600, 330, 100) action Quit(confirm=True)
...
screen about():
    ...
    use game_menu(_("О Дипломе"), scroll="viewport"):
