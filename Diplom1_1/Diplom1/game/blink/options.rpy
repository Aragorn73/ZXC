...
## знака '#' являются закомментированным кодом, и вы можете их
...
init -1 python hide:
    ...
    ##
    ## Функция темы берёт несколько параметров, которые
    ...
    ## Используется при выходе из игрового меню.
...
python early:
    config.save_directory = "simon_game-1489355074"
